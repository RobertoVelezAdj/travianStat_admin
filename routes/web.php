...
Route::put('/Vacas/actualizar_pago2', [App\Http\Controllers\Controller_vacas::class, 'actualizar_pago2'])->middleware('can:Usuario_travian')->name('aldeas.actualizar_pago'); 
